// ==========================================
// 飲食資料庫 (Diet Database) - 已加入你的早餐常用組合
// ==========================================
const dietData = {
    breakfast: [
        { name: "選項A：經典燕麥高蛋白碗（我的最愛）", desc: "1.5杯燕麥片＋無乳糖鮮奶或杏仁奶＋1勺植物/分離蛋白粉＋1根香蕉＋水煮蛋 2 顆。" },
        { name: "選項B：烤地瓜水煮蛋優格組合", desc: "烤地瓜 1 個（中型）＋水煮蛋 3 顆＋無乳糖優格 150g＋半根香蕉。" },
        { name: "選項C：超商快速版", desc: "無糖高纖豆漿 1 瓶＋茶葉蛋 2 顆＋烤地瓜 1 個＋無乳糖鮮奶 250ml。" }
    ],
    lunch: [
...
// ==========================================
// 訓練資料庫 (Workout Database) - 直接示範影片
// ==========================================
const workoutData = {
    "mode_a": {
        name: "週末重裝＋平日居家 (上下半身 4 天分化)",
        description: "週末大重量，平日啞鈴維持。每組間休息 90–120 秒，動作務必維持「3秒下、1秒上」的緩慢節奏，保護關節！",
        schedule: [
            { 
                day: "週六 (健身房)", 
                type: "重訓", 
    ...
    "mode_b": {
        name: "全居家啞鈴模式 (備用方案)",
        description: "週末沒空去健身房時的備用計畫，維持肌肉刺激。動作同樣請維持「3秒下、1秒上」的節奏。",
        schedule: [
